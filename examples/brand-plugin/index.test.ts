...
import { brandPlugin, brandVariants, getBrandPluginStats } from "./index";
...
describe("Brand Plugin", () => {
  ...
  describe("Plugin Registration", () => {
    ...
    it("should register all variants", () => {
      ...
      const expectedCount =
        brandVariants.buttons.length +
        brandVariants.badges.length +
        brandVariants.cards.length;
