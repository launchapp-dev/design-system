...
import { cn } from "../utils/cn";
  ...
  let { variant = "default", size = "md", loading = false, disabled = false, type = "button", class: className, children, ...restProps }: {
...
<button type={type} disabled={isDisabled} class={classes} {...restProps}>
    <svg
      {#if loading}
