...
const sampleFeatures = [
  {
    ...
    description:
      "Built for performance from the ground up. Deploy in seconds, not minutes.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Pick only what you need. Every feature is independently deployable.",
  },
  {
    title: "Global CDN",
    description:
      "Serve your users from 200+ edge locations worldwide with sub-50ms latency.",
  },
  {
    title: "Developer-first APIs",
    description:
      "Clean REST and GraphQL APIs with SDKs for every major language.",
  },
  {
    title: "99.9% uptime SLA",
    description:
      "Backed by our industry-leading reliability commitment and 24/7 support.",
  },
];
