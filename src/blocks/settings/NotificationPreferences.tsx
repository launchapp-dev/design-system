...
const defaultGroups: NotificationGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Special offers, deals, and newsletters.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "push_replies",
        label: "Replies",
        description: "Replies to your comments and posts.",
        defaultChecked: true,
      },
      {
        id: "push_reminders",
        label: "Reminders",
        description: "Scheduled reminders and due-date alerts.",
        defaultChecked: false,
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "inapp_all_activity",
        label: "All activity",
        description: "Show a badge for all new notifications.",
        defaultChecked: true,
      },
      {
        id: "inapp_direct_messages",
      ...
      },
      {
        id: "inapp_system",
        label: "System alerts",
        description: "Maintenance windows and service updates.",
        defaultChecked: true,
      },
    ],
  },
