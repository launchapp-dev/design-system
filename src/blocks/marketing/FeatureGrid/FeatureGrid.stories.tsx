...
const sampleFeatures = [
  ...
  },
  {
    ...
    description:
      "Fully typed TypeScript API with excellent editor support and autocompletion.",
  },
  {
    icon: <IconGlobe />,
    title: "Accessible",
  ...
  },
  {
    ...
    title: "Delightful UX",
    description:
      "Carefully crafted interactions and animations that users will love.",
  },
];
...
export const WithoutIcons: Story = {
  render: () => (
    <FeatureGrid
      ...
      features={sampleFeatures.map(({ title, description }) => ({
        title,
        description,
      }))}
    />
