...
function NotificationBell({
  ...
  const variantClasses = {
    ...
    outline: "border border-[hsl(var(--la-input))] bg-[hsl(var(--la-background))] hover:bg-[hsl(var(--la-accent))]",
  ...
  return (
    <Button
      variant="ghost"
      size="icon"
      className={cn("relative rounded-[--la-radius] p-0", sizeClasses[size], variantClasses[variant], className)}
