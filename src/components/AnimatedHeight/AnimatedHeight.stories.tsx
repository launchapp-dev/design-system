    ...
    <div style={{ width: "320px" }}>
      <AnimatedHeight {...args}>
        ...
        >
          ...
          >
            This content smoothly animates its height when shown or hidden.
            Toggle the isOpen control to see the transition.
          </p>
        </div>
      </AnimatedHeight>
    </div>
      ...
      >
        ...
        <AnimatedHeight isOpen={open}>
          ...
          >
            ...
            >
              This panel expands and collapses with a smooth height animation.
              It's useful for FAQ sections, collapsible sidebars, and
              accordion-like UI patterns.
            </p>
            <p
              style={{
                fontSize: "14px",
            ...
            >
              The height transitions smoothly from 0 to auto and back, without
              janky reflows.
            </p>
          </div>
        </AnimatedHeight>
