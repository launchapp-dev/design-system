    ...
    return (
      ...
      >
        {showGradient && !isVertical && (
          <>
            <div
              className="pointer-events-none absolute start-0 top-0 z-10 h-full bg-gradient-to-r from-[var(--gradient-color,hsl(var(--la-background)))] to-transparent"
              style={{ width: gradientWidthStyle, ...gradientStyle }}
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute end-0 top-0 z-10 h-full bg-gradient-to-l from-[var(--gradient-color,hsl(var(--la-background)))] to-transparent"
              style={{ width: gradientWidthStyle, ...gradientStyle }}
              aria-hidden="true"
            />
          </>
        ...
        {showGradient && isVertical && (
          <>
            <div
              className="pointer-events-none absolute start-0 top-0 z-10 w-full bg-gradient-to-b from-[var(--gradient-color,hsl(var(--la-background)))] to-transparent"
              style={{ height: gradientWidthStyle, ...gradientStyle }}
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute bottom-0 start-0 z-10 w-full bg-gradient-to-t from-[var(--gradient-color,hsl(var(--la-background)))] to-transparent"
              style={{ height: gradientWidthStyle, ...gradientStyle }}
              aria-hidden="true"
            />
          </>
