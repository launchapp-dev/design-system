    ...
    return (
      <Masonry columns={3} gap="md">
        {items.map((item) => (
          <MasonryCard
            key={item.id}
            style={{ minHeight: item.height, padding: "16px" }}
          >
            ...
            >
              Variable height content that demonstrates the masonry layout
              behavior.
            </p>
          </MasonryCard>
        ))}
  ...
  render: () => (
    <Masonry columns={3} gap="md">
      <MasonryCard style={{ padding: "20px", minHeight: 200 }}>
        <h3
          style={{ fontWeight: 700, fontSize: "1.125rem", marginBottom: "8px" }}
        >
          📊 Analytics
        </h3>
        <p
        ...
        >
          Track your key performance indicators with real-time data
          visualization.
        </p>
      ...
      >
        ...
        >
          Get up and running in minutes with our comprehensive documentation and
          starter templates.
        </p>
        <button
          style={{
          ...
          {["JD", "AB", "CD", "+5"].map((initials, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background:
                  i === 3 ? "hsl(var(--muted))" : "hsl(var(--primary) / 0.2)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: "0.625rem",
