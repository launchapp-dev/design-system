        ...
        <Popover defaultOpen>
          ...
          <PopoverContent className="w-96">
            ...
            >
              ...
              <p style={{ fontSize: "13px", color: "var(--muted-foreground)" }}>
                This popover is wider and can contain more content, forms, or
        ...
        <Popover defaultOpen>
          ...
          <PopoverContent>
            <p style={{ fontSize: "13px" }}>
              This popover contains a much longer piece of text that wraps
              across multiple lines to verify that the layout handles overflow
              gracefully without breaking the visual structure.
            </p>
          </PopoverContent>
        </Popover>
      </div>
