...
const buttonVariants = cva(baseButtonClasses, baseButtonConfig);
...
/**
 * Get button variants with plugin support
 * Returns the base variants merged with any registered plugins
 */
export function getButtonVariants() {
  const registry = getPluginRegistry();
  const mergedVariants = registry.mergeVariants("Button", baseButtonConfig.variants);

  return cva(baseButtonClasses, {
    ...baseButtonConfig,
